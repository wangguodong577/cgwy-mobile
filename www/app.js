...
angular.module('cgwy')
    .controller('HomeCtrl', function ($scope, $ionicPopup, $stateParams, $ionicSlideBoxDelegate, $state, $ionicPopover, UpdateService, OrderService, ProfileService, ActivityService, Analytics, AlertService, LocationService, CartService,$rootScope,DeviceUtil) {
		function showBanner(){
        ...
        ProfileService.getProfile().then(function (profile) {
            ...
            if (profile) {
                ...
                ProfileService.getCustomerCityId().then(function(cityId) {
					...
					// $scope.currentCity = cityId === 2 ? "成都" : "北京";
...
angular.module('cgwy')
    .controller('SuccessCtrl', function ($scope, $stateParams, ProfileService , BackUrlUtil) {
...
angular.module('cgwy')
    .factory('VersionService', function ($http, $q, apiConfig,$ionicPopup,$ionicLoading) {
        ...
        service.checkApp = function(versionCode) {
            if(versionCode) {
                return $http({
                    url: apiConfig.host + "/api/legacy/version/check/update",
                    method: 'POST',
